...
service_menu_uz = types.InlineKeyboardButton(text="Servis", callback_data="get_service_1")
moyka_menu_uz = types.InlineKeyboardButton(text="Moyka", callback_data="get_moyka_1")
zapravka_menu_uz = types.InlineKeyboardButton(text="Zapravka", callback_data="get_zapravka_1")
favourites_menu_uz = types.InlineKeyboardButton(text="Sevimlilar", callback_data="get_favourites_1")
...
service_menu_ru = types.InlineKeyboardButton(text="Servis", callback_data="get_service_1")
moyka_menu_ru = types.InlineKeyboardButton(text="Moyka", callback_data="get_moyka_1")
zapravka_menu_ru = types.InlineKeyboardButton(text="Zapravka", callback_data="get_zapravka_1")
favourites_menu_ru = types.InlineKeyboardButton(text="Sevimlilar", callback_data="get_favourites_1")
...
request_location_uz = types.KeyboardButton("Manzilimni yuborish", request_location=True)
...
request_location_ru = types.KeyboardButton("Manzilimni yuborish", request_location=True)
